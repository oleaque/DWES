...
class Dispatcher
{
    ...
    private function dispatch()
    {
        ...
        if (isset($this->routeList[$this->currentRequest->getRoute()])) {
            //Aqui dentro tenetemos un texto del tipo AEV2\Controller\DetalleController
            $controllerClass = "AEV2\\Controllers\\" . $this->routeList[$this->currentRequest->getRoute()]["controller"];
            //Es equivalente a $controller = new AEV2\Controller\MainController o DetalleController;
